...
m3 = Membership.create(name: 'Social', mtype: true, launch_fee:4.50, soaring_fee:0.15,aerotow_standard_fee: 20, aerotow_unit_fee: 5)
...
m6 = Membership.create(name: 'Social', mtype: false, launch_fee:4.50, soaring_fee:0.3,aerotow_standard_fee: 20, aerotow_unit_fee: 5)
...
m9 = Membership.create(name: 'Social', mtype: false, launch_fee:6.00, soaring_fee:0.3,aerotow_standard_fee: 20, aerotow_unit_fee: 5)
